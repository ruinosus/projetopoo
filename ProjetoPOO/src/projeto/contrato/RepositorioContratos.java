...
public class RepositorioContratos implements IRepositorioContratos {
	...
	private static final String QUERY_SELECT_CODIGO = "SELECT * FROM CONTRATO WHERE COD_CONTRATO = ?";
	private static final String QUERY_SELECT_NOME = "SELECT * FROM CONTRATO WHERE NOME_RESPONSAVEL LIKE ?" ;
